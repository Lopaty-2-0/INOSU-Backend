...
def login():
    ...
    return sendResponse(200, 6031, {"message": "Login successful", "user": {"id": user.id, "name": user.name, "surname": user.surname, "abbreviation": user.abbreviation, "role": user.role, "profilePicture": encoded_file, "email": user.email, "idClass": user.idClass}}, "success")
